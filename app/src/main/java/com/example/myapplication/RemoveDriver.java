                ...
                SearchRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.hasChildren()){
                            ...
                            Toast.makeText(RemoveDriver.this, "No Source to Display", Toast.LENGTH_SHORT).show();
                        }
                    }
                ...
                delRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.hasChild(txtNIC.getText().toString())){
                            ...
                            Toast.makeText(RemoveDriver.this, "Remove Successfully", Toast.LENGTH_SHORT).show();
                        }

                        else{

                            Toast.makeText(RemoveDriver.this, "No Source to Delete", Toast.LENGTH_SHORT).show();
                        }
                    }
